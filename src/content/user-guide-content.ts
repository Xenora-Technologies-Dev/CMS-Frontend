...
export const ADMIN_USER_GUIDE: UserGuideContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        'Bookings calendar: open Appointments → Bookings. Therapy rooms show first, then consultation rooms.',
        'Click a slot or Create Booking. Choose booking type (Therapy Booking is default, or Consultation Booking).',
        'For therapy: search patient, therapist, and therapy. Package therapies show session count. Pick date, time, and room.',
        'For consultation: pick patient, doctor, duration, room, and walk-in or call mode.',
