...
import {
  ...
  type TherapistNavGroup,
  type TherapistNavItem,
  type TherapistNavLink,
  isPathActive,
  isTherapistNavGroupActive,
  isTherapistNavLinkActive,
} from '@/config/therapist-navigation';
...
interface TherapistSidebarNavProps {
  onNavigate?: () => void;
  className?: string;
}
...
function NavLinkItem({
  ...
  item: TherapistNavLink;
  pathname: string;
  onNavigate?: () => void;
}) {
  const active = isTherapistNavLinkActive(pathname, item);
...
function NavGroupItem({
  ...
  group: TherapistNavGroup;
  pathname: string;
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onNavigate?: () => void;
}) {
  const groupActive = isTherapistNavGroupActive(pathname, group);
...
export function TherapistSidebarNav({ onNavigate, className }: TherapistSidebarNavProps) {
